...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya39.ui'
#
...
import sys
from ques40 import *
class Ui_ques39(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques39):
        ques39.setObjectName("ques39")
        ques39.resize(1024, 720)
        ques39.setMinimumSize(QtCore.QSize(1024, 720))
        ques39.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques39)
        ...
        self.label_4.setGeometry(QtCore.QRect(370, 70, 291, 41))
        ...
        ques39.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques39)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques39.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques39)
        self.statusbar.setObjectName("statusbar")
        ques39.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques39)
        QtCore.QMetaObject.connectSlotsByName(ques39)

    def retranslateUi(self, ques39):
        _translate = QtCore.QCoreApplication.translate
        ques39.setWindowTitle(_translate("ques39", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques39", "Hegyvidék | Kilencedik feladat"))
        self.label_2.setText(_translate("ques39", "Becenév:"))
        self.label_3.setText(_translate("ques39", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques39", "9. feladat:"))
        self.R1.setText(_translate("ques39", "-10001"))
        self.R2.setText(_translate("ques39", "-10002"))
        self.R3.setText(_translate("ques39", "-10003"))
        self.B1.setText(_translate("ques39", "Következő"))
        self.R4.setText(_translate("ques39", "10003"))
        self.label_6.setText(_translate("ques39", "Határozd meg a {-10001;-10001;-10002;-10002;10003;10003;10003;-10004} számok móduszát!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques39.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques40(self.name,self.count,self.total)
