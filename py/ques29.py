...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya29.ui'
#
...
import sys
from ques30 import *
class Ui_ques29(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques29):
        ques29.setObjectName("ques29")
        ques29.resize(1024, 720)
        ques29.setMinimumSize(QtCore.QSize(1024, 720))
        ques29.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques29)
        ...
        ques29.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques29)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques29.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques29)
        self.statusbar.setObjectName("statusbar")
        ques29.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques29)
        QtCore.QMetaObject.connectSlotsByName(ques29)

    def retranslateUi(self, ques29):
        _translate = QtCore.QCoreApplication.translate
        ques29.setWindowTitle(_translate("ques29", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques29", "Sivatag | Kilencedik feladat"))
        self.label_2.setText(_translate("ques29", "Becenév:"))
        self.label_3.setText(_translate("ques29", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques29", "9. feladat:"))
        self.R1.setText(_translate("ques29", "1408"))
        self.R2.setText(_translate("ques29", "1409"))
        self.R3.setText(_translate("ques29", "1410"))
        self.B1.setText(_translate("ques29", "Következő"))
        self.R4.setText(_translate("ques29", "1411"))
        self.label_6.setText(_translate("ques29", "Egy falu lakosainak 56%-a férfi. Hány nő él a 3200 fős faluban?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques29.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques30(self.name,self.count,self.total)
