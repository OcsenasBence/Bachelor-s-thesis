...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya24.ui'
#
...
class Ui_ques24(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques24):
        ques24.setObjectName("ques24")
        ques24.resize(1024, 720)
        ques24.setMinimumSize(QtCore.QSize(1024, 720))
        ques24.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques24)
        ...
        self.label_6.setGeometry(QtCore.QRect(170, 270, 771, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques24.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques24)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques24.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques24)
        self.statusbar.setObjectName("statusbar")
        ques24.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques24)
        QtCore.QMetaObject.connectSlotsByName(ques24)

    def retranslateUi(self, ques24):
        _translate = QtCore.QCoreApplication.translate
        ques24.setWindowTitle(_translate("ques24", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques24", "Sivatag | Negyedik feladat"))
        self.label_2.setText(_translate("ques24", "Becenév:"))
        self.label_3.setText(_translate("ques24", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques24", "4. feladat:"))
        self.R1.setText(_translate("ques24", "6500"))
        self.R2.setText(_translate("ques24", "6575"))
        self.R3.setText(_translate("ques24", "621"))
        self.B1.setText(_translate("ques24", "Következő"))
        self.R4.setText(_translate("ques24", "6279"))
        self.label_6.setText(_translate("ques24", "Egy kabát tavalyi ára 6900 forint. Az idén 9%-kal leengedték az árát. Mennyibe kerül most?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques24.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques25(self.name,self.count,self.total)
