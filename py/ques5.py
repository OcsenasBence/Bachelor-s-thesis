...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya5.ui'
#
...
class Ui_ques5(QtWidgets.QWidget):
    ...
    def setupUi(self, ques5):
        ...
        ques5.resize(1024, 720)
        ques5.setMinimumSize(QtCore.QSize(1024, 720))
        ques5.setMaximumSize(QtCore.QSize(1024, 720))
        ...
        self.label_6.setPixmap(QtGui.QPixmap("képek/5. feladat képe.png"))
    ...
    def retranslateUi(self, ques5):
        ...
        ques5.setWindowTitle(_translate("ques5", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques5", "Füves puszta | Ötödik feladat"))
        self.label_2.setText(_translate("ques5", "Becenév:"))
        self.label_3.setText(_translate("ques5", "Hátralévő idő:"))
        self.R1.setText(_translate("ques5", "36"))
        self.R2.setText(_translate("ques5", "37"))
        self.R3.setText(_translate("ques5", "38"))
        self.R4.setText(_translate("ques5", "39"))
        self.B1.setText(_translate("ques5", "Következő"))
        self.label_5.setText(_translate("ques5", "5. feladat: Melyik szám van a négyzet alatt?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques5.hide)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques6(self.name,self.count,self.total)
