...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya48.ui'
#
...
import sys
from ques49 import *
class Ui_ques48(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques48):
        ques48.setObjectName("ques48")
        ques48.resize(1024, 720)
        ques48.setMinimumSize(QtCore.QSize(1024, 720))
        ques48.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques48)
        ...
        self.label_6.setGeometry(QtCore.QRect(160, 270, 701, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques48.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques48)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques48.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques48)
        self.statusbar.setObjectName("statusbar")
        ques48.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques48)
        QtCore.QMetaObject.connectSlotsByName(ques48)

    def retranslateUi(self, ques48):
        _translate = QtCore.QCoreApplication.translate
        ques48.setWindowTitle(_translate("ques48", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques48", "Szavanna | Nyolcadik feladat"))
        self.label_2.setText(_translate("ques48", "Becenév:"))
        self.label_3.setText(_translate("ques48", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques48", "8. feladat:"))
        self.R1.setText(_translate("ques48", "1052"))
        self.R2.setText(_translate("ques48", "1060"))
        self.R3.setText(_translate("ques48", "1704"))
        self.B1.setText(_translate("ques48", "Következő"))
        self.R4.setText(_translate("ques48", "1825"))
        self.label_6.setText(_translate("ques48", "Határozd meg a {-2948;-7845;1052;985;6589;8547;4857;2356} számok mediánját!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques48.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques49(self.name,self.count,self.total)
