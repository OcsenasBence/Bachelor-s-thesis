...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya49.ui'
#
...
import sys
from ques50 import *
class Ui_ques49(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques49):
        ques49.setObjectName("ques49")
        ques49.resize(1024, 720)
        ques49.setMinimumSize(QtCore.QSize(1024, 720))
        ques49.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques49)
        ...
        self.label_6.setGeometry(QtCore.QRect(190, 250, 591, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques49.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques49)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques49.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques49)
        self.statusbar.setObjectName("statusbar")
        ques49.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques49)
        QtCore.QMetaObject.connectSlotsByName(ques49)

    def retranslateUi(self, ques49):
        _translate = QtCore.QCoreApplication.translate
        ques49.setWindowTitle(_translate("ques49", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques49", "Szavanna | Kilencedik feladat"))
        self.label_2.setText(_translate("ques49", "Becenév:"))
        self.label_3.setText(_translate("ques49", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques49", "9. feladat:"))
        self.R1.setText(_translate("ques49", "7"))
        self.R2.setText(_translate("ques49", "77"))
        self.R3.setText(_translate("ques49", "777"))
        self.B1.setText(_translate("ques49", "Következő"))
        self.R4.setText(_translate("ques49", "7777"))
        self.label_6.setText(_translate("ques49", "Határozd meg a {7;77;777;7777;7;777;77;7;7777} számok mediánját!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques49.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques50(self.name,self.count,self.total)
