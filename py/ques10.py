...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya10.ui'
#
...
class Ui_ques10(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques10):
        ques10.setObjectName("ques10")
        ques10.resize(1024, 720)
        ques10.setMinimumSize(QtCore.QSize(1024, 720))
        ques10.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques10)
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(300, 390, 415, 251))
        ...
        self.label_6.setPixmap(QtGui.QPixmap("képek/10. feladat képe.png"))
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques10.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques10)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques10.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques10)
        self.statusbar.setObjectName("statusbar")
        ques10.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques10)
        QtCore.QMetaObject.connectSlotsByName(ques10)

    def retranslateUi(self, ques10):
        _translate = QtCore.QCoreApplication.translate
        ques10.setWindowTitle(_translate("ques10", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques10", "Füves puszta | Tizedik feladat"))
        self.label_2.setText(_translate("ques10", "Becenév:"))
        self.label_3.setText(_translate("ques10", "Hátralévő idő:"))
        self.R1.setText(_translate("ques10", "6/9"))
        self.R2.setText(_translate("ques10", "5/7"))
        self.R3.setText(_translate("ques10", "2/3"))
        self.R4.setText(_translate("ques10", "3/4"))
        self.B1.setText(_translate("ques10", "Következő"))
        self.label_5.setText(_translate("ques10", "10. feladat: Egyszerüsítsd a képen látható törtet!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques10.hide)
