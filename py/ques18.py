...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya18.ui'
#
...
class Ui_ques18(QtWidgets.QWidget):
    ...
    def setupUi(self, ques18):
        ques18.setObjectName("ques18")
        ques18.resize(1024, 720)
        ques18.setMinimumSize(QtCore.QSize(1024, 720))
        ques18.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques18)
        ...
        ques18.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques18)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques18.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques18)
        self.statusbar.setObjectName("statusbar")
        ques18.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques18)
        QtCore.QMetaObject.connectSlotsByName(ques18)

    def retranslateUi(self, ques18):
        _translate = QtCore.QCoreApplication.translate
        ques18.setWindowTitle(_translate("ques18", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques18", "Esőerdő | Nyolcadik feladat"))
        self.label_2.setText(_translate("ques18", "Becenév:"))
        self.label_3.setText(_translate("ques18", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques18", "8. feladat: Végezd el az alábbi műveletet!"))
        self.R1.setText(_translate("ques18", "2308,5"))
        self.R2.setText(_translate("ques18", "2318,5"))
        self.R3.setText(_translate("ques18", "2378,5"))
        self.B1.setText(_translate("ques18", "Következő"))
        self.R4.setText(_translate("ques18", "2348,5"))
        self.label_6.setText(_translate("ques18",
                                        "<html><head/><body><p><span style=\" font-size:14pt;\">3,5 * 671 =</span></p></body></html>"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques18.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques19(self.name, self.count, self.total)
