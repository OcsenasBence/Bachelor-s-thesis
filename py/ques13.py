...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya13.ui'
#
...
class Ui_ques13(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques13):
        ques13.setObjectName("ques13")
        ques13.resize(1024, 720)
        ques13.setMinimumSize(QtCore.QSize(1024, 720))
        ques13.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques13)
        ...
        ques13.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques13)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques13.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques13)
        self.statusbar.setObjectName("statusbar")
        ques13.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques13)
        QtCore.QMetaObject.connectSlotsByName(ques13)

    def retranslateUi(self, ques13):
        _translate = QtCore.QCoreApplication.translate
        ques13.setWindowTitle(_translate("ques13", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques13", "Esőerdő | Harmadik feladat"))
        self.label_2.setText(_translate("ques13", "Becenév:"))
        self.label_3.setText(_translate("ques13", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques13", "3. feladat: Melyik tizedes tört a nagyobb?"))
        self.R1.setText(_translate("ques13", "5,03"))
        self.R2.setText(_translate("ques13", "5,1"))
        self.R3.setText(_translate("ques13", "Egyenlőek"))
        self.B1.setText(_translate("ques13", "Következő"))
        self.label_6.setText(_translate("ques13",
                                        "<html><head/><body><p><span style=\" font-size:14pt;\">5,03  |  5,1</span></p></body></html>"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques13.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques14(self.name,self.count,self.total)
