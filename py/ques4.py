...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya4.ui'
#
...
class Ui_ques4(QtWidgets.QWidget):
    ...
    def setupUi(self, ques4):
        ...
        ques4.resize(1024, 720)
        ques4.setMinimumSize(QtCore.QSize(1024, 720))
        ques4.setMaximumSize(QtCore.QSize(1024, 720))
        ...
        self.label_6.setPixmap(QtGui.QPixmap("képek/4. feladat képe.png"))
    ...
    def retranslateUi(self, ques4):
        ...
        ques4.setWindowTitle(_translate("ques4", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques4", "Füves puszta | Negyedik feladat"))
        self.label_2.setText(_translate("ques4", "Becenév:"))
        self.label_3.setText(_translate("ques4", "Hátralévő idő:"))
        self.R1.setText(_translate("ques4", "34"))
        self.R2.setText(_translate("ques4", "35"))
        self.R3.setText(_translate("ques4", "36"))
        self.R4.setText(_translate("ques4", "37"))
        self.B1.setText(_translate("ques4", "Következő"))
        self.label_5.setText(_translate("ques4", "4. feladat: Melyik szám van a négyzet alatt?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques4.hide)
