...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya28.ui'
#
...
import sys
from ques29 import *
class Ui_ques28(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques28):
        ques28.setObjectName("ques28")
        ques28.resize(1024, 720)
        ques28.setMinimumSize(QtCore.QSize(1024, 720))
        ques28.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques28)
        ...
        self.label_6.setGeometry(QtCore.QRect(230, 280, 561, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques28.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques28)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques28.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques28)
        self.statusbar.setObjectName("statusbar")
        ques28.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques28)
        QtCore.QMetaObject.connectSlotsByName(ques28)

    def retranslateUi(self, ques28):
        _translate = QtCore.QCoreApplication.translate
        ques28.setWindowTitle(_translate("ques28", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques28", "Sivatag | Nyolcadik feladat"))
        self.label_2.setText(_translate("ques28", "Becenév:"))
        self.label_3.setText(_translate("ques28", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques28", "8. feladat:"))
        self.R1.setText(_translate("ques28", "24"))
        self.R2.setText(_translate("ques28", "26"))
        self.R3.setText(_translate("ques28", "28"))
        self.B1.setText(_translate("ques28", "Következő"))
        self.R4.setText(_translate("ques28", "30"))
        self.label_6.setText(_translate("ques28", "A gomba 80%-a víz. Hány kg gombából lesz 6kg szárított gomba?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques28.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques29(self.name,self.count,self.total)
