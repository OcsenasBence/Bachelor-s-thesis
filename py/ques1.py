...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya1.ui'
#
...
class Ui_ques1(QtWidgets.QWidget):
    ...
    def setupUi(self, ques1):
        ...
        ques1.resize(1024, 720)
        ques1.setMinimumSize(QtCore.QSize(1024, 720))
        ques1.setMaximumSize(QtCore.QSize(1024, 720))
        ...
        self.label_4.setGeometry(QtCore.QRect(340, 60, 261, 41))
        ...
        self.label_6.setPixmap(QtGui.QPixmap("képek/1. feladat képe.png"))
    ...
    def retranslateUi(self, ques1):
        ...
        ques1.setWindowTitle(_translate("ques1", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques1", "Füves puszta | Első feladat"))
        self.label_2.setText(_translate("ques1", "Becenév:"))
        self.label_3.setText(_translate("ques1", "Hátralévő idő:"))
        self.R1.setText(_translate("ques1", "6"))
        self.R2.setText(_translate("ques1", "7"))
        self.R3.setText(_translate("ques1", "5"))
        self.R4.setText(_translate("ques1", "4"))
        self.B1.setText(_translate("ques1", "Következő"))
        self.label_5.setText(_translate("ques1", "1. feladat: Melyik szám van a négyzet alatt?"))
        self.button.setText(_translate("ques1", "?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques1.hide)

    def show_popup(self):
        msg = QMessageBox()
        msg.setWindowTitle("Füves puszta ismertető")
        msg.setText("Üdvözöllek az első szinten! A következő pályán 30 perced van teljesíteni az összes feladatot.")
