...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya42.ui'
#
...
import sys
from ques43 import *
class Ui_ques42(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques42):
        ques42.setObjectName("ques42")
        ques42.resize(1024, 720)
        ques42.setMinimumSize(QtCore.QSize(1024, 720))
        ques42.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques42)
        ...
        ques42.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques42)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques42.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques42)
        self.statusbar.setObjectName("statusbar")
        ques42.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques42)
        QtCore.QMetaObject.connectSlotsByName(ques42)

    def retranslateUi(self, ques42):
        _translate = QtCore.QCoreApplication.translate
        ques42.setWindowTitle(_translate("ques42", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques42", "Szavanna | Második feladat"))
        self.label_2.setText(_translate("ques42", "Becenév:"))
        self.label_3.setText(_translate("ques42", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques42", "2. feladat:"))
        self.R1.setText(_translate("ques42", "-1"))
        self.R2.setText(_translate("ques42", "1"))
        self.R3.setText(_translate("ques42", "3"))
        self.B1.setText(_translate("ques42", "Következő"))
        self.R4.setText(_translate("ques42", "6"))
        self.label_6.setText(_translate("ques42", "Határozd meg a {−1;−1;1;1;3;6} számok mediánját!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques42.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques43(self.name,self.count,self.total)
