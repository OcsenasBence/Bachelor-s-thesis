...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya34.ui'
#
...
import sys
from ques35 import *
class Ui_ques34(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques34):
        ques34.setObjectName("ques34")
        ques34.resize(1024, 720)
        ques34.setMinimumSize(QtCore.QSize(1024, 720))
        ques34.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques34)
        ...
        self.label_6.setGeometry(QtCore.QRect(230, 270, 571, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques34.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques34)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques34.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques34)
        self.statusbar.setObjectName("statusbar")
        ques34.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques34)
        QtCore.QMetaObject.connectSlotsByName(ques34)

    def retranslateUi(self, ques34):
        _translate = QtCore.QCoreApplication.translate
        ques34.setWindowTitle(_translate("ques34", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques34", "Hegyvidék | Negyedik feladat"))
        self.label_2.setText(_translate("ques34", "Becenév:"))
        self.label_3.setText(_translate("ques34", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques34", "4. feladat:"))
        self.R1.setText(_translate("ques34", "1,5"))
        self.R2.setText(_translate("ques34", "1,6"))
        self.R3.setText(_translate("ques34", "1,7"))
        self.B1.setText(_translate("ques34", "Következő"))
        self.R4.setText(_translate("ques34", "2"))
        self.label_6.setText(_translate("ques34", "Határozd meg a {1,5;1,5;1,6;1,6;1,7;1,7;1,7;2} számok móduszát!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques34.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques35(self.name,self.count,self.total)
