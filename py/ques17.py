...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya17.ui'
#
...
class Ui_ques17(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques17):
        ques17.setObjectName("ques17")
        ques17.resize(1024, 720)
        ques17.setMinimumSize(QtCore.QSize(1024, 720))
        ques17.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques17)
        ...
        ques17.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques17)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques17.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques17)
        self.statusbar.setObjectName("statusbar")
        ques17.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques17)
        QtCore.QMetaObject.connectSlotsByName(ques17)

    def retranslateUi(self, ques17):
        _translate = QtCore.QCoreApplication.translate
        ques17.setWindowTitle(_translate("ques17", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques17", "Esőerdő | Hetedik feladat"))
        self.label_2.setText(_translate("ques17", "Becenév:"))
        self.label_3.setText(_translate("ques17", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques17", "7. feladat: Végezd el az alábbi műveletet!"))
        self.R1.setText(_translate("ques17", "90"))
        self.R2.setText(_translate("ques17", "91"))
        self.R3.setText(_translate("ques17", "92"))
        self.B1.setText(_translate("ques17", "Következő"))
        self.R4.setText(_translate("ques17", "93"))
        self.label_6.setText(_translate("ques17", "<html><head/><body><p><span style=\" font-size:14pt;\">2,6 * 35 =</span></p></body></html>"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques17.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques18(self.name,self.count,self.total)
