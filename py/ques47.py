...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya47.ui'
#
...
import sys
from ques48 import *
class Ui_ques47(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques47):
        ques47.setObjectName("ques47")
        ques47.resize(1024, 720)
        ques47.setMinimumSize(QtCore.QSize(1024, 720))
        ques47.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques47)
        ...
        self.label_6.setGeometry(QtCore.QRect(220, 270, 581, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques47.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques47)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques47.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques47)
        self.statusbar.setObjectName("statusbar")
        ques47.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques47)
        QtCore.QMetaObject.connectSlotsByName(ques47)

    def retranslateUi(self, ques47):
        _translate = QtCore.QCoreApplication.translate
        ques47.setWindowTitle(_translate("ques47", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques47", "Szavanna | Hetedik feladat"))
        self.label_2.setText(_translate("ques47", "Becenév:"))
        self.label_3.setText(_translate("ques47", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques47", "7. feladat:"))
        self.R1.setText(_translate("ques47", "0"))
        self.R2.setText(_translate("ques47", "246"))
        self.R3.setText(_translate("ques47", "487"))
        self.B1.setText(_translate("ques47", "Következő"))
        self.R4.setText(_translate("ques47", "334,5"))
        self.label_6.setText(_translate("ques47", "Határozd meg a {-105;-276;487;295;7854;246;0} számok mediánját!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques47.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques48(self.name,self.count,self.total)
