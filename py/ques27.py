...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya27.ui'
#
...
import sys
from ques28 import *
class Ui_ques27(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques27):
        ques27.setObjectName("ques27")
        ques27.resize(1024, 720)
        ques27.setMinimumSize(QtCore.QSize(1024, 720))
        ques27.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques27)
        ...
        self.label_6.setGeometry(QtCore.QRect(340, 280, 321, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques27.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques27)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques27.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques27)
        self.statusbar.setObjectName("statusbar")
        ques27.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques27)
        QtCore.QMetaObject.connectSlotsByName(ques27)

    def retranslateUi(self, ques27):
        _translate = QtCore.QCoreApplication.translate
        ques27.setWindowTitle(_translate("ques27", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques27", "Sivatag | Hetedik feladat"))
        self.label_2.setText(_translate("ques27", "Becenév:"))
        self.label_3.setText(_translate("ques27", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques27", "7. feladat:"))
        self.R1.setText(_translate("ques27", "86,3"))
        self.R2.setText(_translate("ques27", "86,4"))
        self.R3.setText(_translate("ques27", "86,5"))
        self.B1.setText(_translate("ques27", "Következő"))
        self.R4.setText(_translate("ques27", "86,6"))
        self.label_6.setText(_translate("ques27", "Hány liter a 240 literes hordó 36%-a?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques27.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques28(self.name,self.count,self.total)
