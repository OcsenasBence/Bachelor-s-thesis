...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya3.ui'
#
...
class Ui_ques3(QtWidgets.QWidget):
    ...
    def setupUi(self, ques3):
        ...
        ques3.resize(1024, 720)
        ques3.setMinimumSize(QtCore.QSize(1024, 720))
        ques3.setMaximumSize(QtCore.QSize(1024, 720))
        ...
        self.label_6.setPixmap(QtGui.QPixmap("képek/3. feladat képe.png"))
    ...
    def retranslateUi(self, ques3):
        ...
        ques3.setWindowTitle(_translate("ques3", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques3", "Füves puszta | Harmadik feladat"))
        self.label_2.setText(_translate("ques3", "Becenév:"))
        self.label_3.setText(_translate("ques3", "Hátralévő idő:"))
        self.R1.setText(_translate("ques3", "70"))
        self.R2.setText(_translate("ques3", "60"))
        self.R3.setText(_translate("ques3", "50"))
        self.R4.setText(_translate("ques3", "40"))
        self.B1.setText(_translate("ques3", "Következő"))
        self.label_5.setText(_translate("ques3", "3. feladat: Melyik szám van a négyzet alatt?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques3.hide)
