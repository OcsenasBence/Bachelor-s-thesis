...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya16.ui'
#
...
class Ui_ques16(QtWidgets.QWidget):
    ...
    def setupUi(self, ques16):
        ques16.setObjectName("ques16")
        ques16.resize(1024, 720)
        ques16.setMinimumSize(QtCore.QSize(1024, 720))
        ques16.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques16)
        ...
        self.label_6.setGeometry(QtCore.QRect(450, 280, 200, 71))
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques16.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques16)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques16.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques16)
        self.statusbar.setObjectName("statusbar")
        ques16.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques16)
        QtCore.QMetaObject.connectSlotsByName(ques16)

    def retranslateUi(self, ques16):
        _translate = QtCore.QCoreApplication.translate
        ques16.setWindowTitle(_translate("ques16", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques16", "Esőerdő | Hatodik feladat"))
        self.label_2.setText(_translate("ques16", "Becenév:"))
        self.label_3.setText(_translate("ques16", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques16", "6. feladat: Végezd el az alábbi műveletet!"))
        self.R1.setText(_translate("ques16", "450,149"))
        self.R2.setText(_translate("ques16", "450,150"))
        self.R3.setText(_translate("ques16", "450,151"))
        self.B1.setText(_translate("ques16", "Következő"))
        self.R4.setText(_translate("ques16", "450,152"))
        self.label_6.setText(_translate("ques16",
                                        "<html><head/><body><p><span style=\" font-size:14pt;\">382,19 + 67,961 =</span></p></body></html>"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques16.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques17(self.name, self.count, self.total)
