...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya23.ui'
#
...
import sys
from ques24 import *
class Ui_ques23(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques23):
        ques23.setObjectName("ques23")
        ques23.resize(1024, 720)
        ques23.setMinimumSize(QtCore.QSize(1024, 720))
        ques23.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques23)
        ...
        self.label_6.setGeometry(QtCore.QRect(170, 270, 761, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques23.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques23)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques23.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques23)
        self.statusbar.setObjectName("statusbar")
        ques23.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques23)
        QtCore.QMetaObject.connectSlotsByName(ques23)

    def retranslateUi(self, ques23):
        _translate = QtCore.QCoreApplication.translate
        ques23.setWindowTitle(_translate("ques23", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques23", "Sivatag | Harmadik feladat"))
        self.label_2.setText(_translate("ques23", "Becenév:"))
        self.label_3.setText(_translate("ques23", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques23", "3. feladat:"))
        self.R1.setText(_translate("ques23", "4620"))
        self.R2.setText(_translate("ques23", "10780"))
        self.R3.setText(_translate("ques23", "12575"))
        self.B1.setText(_translate("ques23", "Következő"))
        self.R4.setText(_translate("ques23", "12000,5"))
        self.label_6.setText(_translate("ques23", "Egy nyomtató 15400 forint. 30%-kal leszállították az árát. Mennyibe kerül most?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques23.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques24(self.name,self.count,self.total)
