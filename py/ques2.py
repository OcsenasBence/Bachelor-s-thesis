...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya2.ui'
#
...
class Ui_ques2(QtWidgets.QWidget):
    ...
    def setupUi(self, ques2):
        ...
        ques2.resize(1024, 720)
        ques2.setMinimumSize(QtCore.QSize(1024, 720))
        ques2.setMaximumSize(QtCore.QSize(1024, 720))
        ...
        self.label_4.setGeometry(QtCore.QRect(340, 60, 301, 41))
        ...
        self.label_6.setPixmap(QtGui.QPixmap("képek/2. feladat képe.png"))
    ...
    def retranslateUi(self, ques2):
        ...
        ques2.setWindowTitle(_translate("ques2", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques2", "Füves puszta | Második feladat"))
        self.label_2.setText(_translate("ques2", "Becenév:"))
        self.label_3.setText(_translate("ques2", "Hátralévő idő:"))
        self.R1.setText(_translate("ques2", "6"))
        self.R2.setText(_translate("ques2", "7"))
        self.R3.setText(_translate("ques2", "5"))
        self.R4.setText(_translate("ques2", "4"))
        self.B1.setText(_translate("ques2", "Következő"))
        self.label_5.setText(_translate("ques2", "2. feladat: Melyik szám van a négyzet alatt?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques2.hide)
