...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya9.ui'
#
...
class Ui_ques9(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques9):
        ques9.setObjectName("ques9")
        ques9.resize(1024, 720)
        ques9.setMinimumSize(QtCore.QSize(1024, 720))
        ques9.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques9)
        ...
        self.label_6.setPixmap(QtGui.QPixmap("képek/9. feladat képe.png"))
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques9.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques9)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques9.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques9)
        self.statusbar.setObjectName("statusbar")
        ques9.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques9)
        QtCore.QMetaObject.connectSlotsByName(ques9)

    def retranslateUi(self, ques9):
        _translate = QtCore.QCoreApplication.translate
        ques9.setWindowTitle(_translate("ques9", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques9", "Füves puszta | Kilencedik feladat"))
        self.label_2.setText(_translate("ques9", "Becenév:"))
        self.label_3.setText(_translate("ques9", "Hátralévő idő:"))
        self.R1.setText(_translate("ques9", "1/1"))
        self.R2.setText(_translate("ques9", "5/7"))
        self.R3.setText(_translate("ques9", "3/4"))
        self.R4.setText(_translate("ques9", "12/16"))
        self.B1.setText(_translate("ques9", "Következő"))
        self.label_5.setText(_translate("ques9", "9. feladat: Egyszerüsítsd a képen látható törtet!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques9.hide)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques10(self.name,self.count,self.total)
