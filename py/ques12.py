...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya12.ui'
#
...
class Ui_ques12(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques12):
        ques12.setObjectName("ques12")
        ques12.resize(1024, 720)
        ques12.setMinimumSize(QtCore.QSize(1024, 720))
        ques12.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques12)
        ...
        ques12.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques12)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques12.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques12)
        self.statusbar.setObjectName("statusbar")
        ques12.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques12)
        QtCore.QMetaObject.connectSlotsByName(ques12)

    def retranslateUi(self, ques12):
        _translate = QtCore.QCoreApplication.translate
        ques12.setWindowTitle(_translate("ques12", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques12", "Esőerdő | Második feladat"))
        self.label_2.setText(_translate("ques12", "Becenév:"))
        self.label_3.setText(_translate("ques12", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques12", "2. feladat: Melyik tizedes tört a nagyobb?"))
        self.R1.setText(_translate("ques12", "4,1221"))
        self.R2.setText(_translate("ques12", "4,2112"))
        self.R3.setText(_translate("ques12", "Egyenlőek"))
        self.B1.setText(_translate("ques12", "Következő"))
        self.label_6.setText(_translate("ques12",
                                        "<html><head/><body><p><span style=\" font-size:14pt;\">4,1221  |  4,2112 =</span></p></body></html>"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques12.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques13(self.name,self.count,self.total)
