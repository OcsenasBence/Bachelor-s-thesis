...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya7.ui'
#
...
class Ui_ques7(QtWidgets.QWidget):
    ...
    def setupUi(self, ques7):
        ...
        ques7.resize(1024, 720)
        ques7.setMinimumSize(QtCore.QSize(1024, 720))
        ques7.setMaximumSize(QtCore.QSize(1024, 720))
        ...
        self.label_6.setPixmap(QtGui.QPixmap("képek/7. feladat képe.png"))
    ...
    def retranslateUi(self, ques7):
        ...
        ques7.setWindowTitle(_translate("ques7", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques7", "Füves puszta | Hetedik feladat"))
        self.label_2.setText(_translate("ques7", "Becenév:"))
        self.label_3.setText(_translate("ques7", "Hátralévő idő:"))
        self.R1.setText(_translate("ques7", "3/5"))
        self.R2.setText(_translate("ques7", "2/4"))
        self.R3.setText(_translate("ques7", "1/1"))
        self.R4.setText(_translate("ques7", "3/4"))
        self.B1.setText(_translate("ques7", "Következő"))
        self.label_5.setText(_translate("ques7", "7. feladat: Egyszerüsítsd a képen látható törtet!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques7.hide)
