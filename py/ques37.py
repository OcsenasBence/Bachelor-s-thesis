...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya37.ui'
#
...
import sys
from ques38 import *
class Ui_ques37(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques37):
        ques37.setObjectName("ques37")
        ques37.resize(1024, 720)
        ques37.setMinimumSize(QtCore.QSize(1024, 720))
        ques37.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques37)
        ...
        self.label_6.setGeometry(QtCore.QRect(250, 270, 511, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques37.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques37)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques37.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques37)
        self.statusbar.setObjectName("statusbar")
        ques37.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques37)
        QtCore.QMetaObject.connectSlotsByName(ques37)

    def retranslateUi(self, ques37):
        _translate = QtCore.QCoreApplication.translate
        ques37.setWindowTitle(_translate("ques37", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques37", "Hegyvidék | Hetedik feladat"))
        self.label_2.setText(_translate("ques37", "Becenév:"))
        self.label_3.setText(_translate("ques37", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques37", "7. feladat:"))
        self.R1.setText(_translate("ques37", "-2"))
        self.R2.setText(_translate("ques37", "-1"))
        self.R3.setText(_translate("ques37", "1"))
        self.B1.setText(_translate("ques37", "Következő"))
        self.R4.setText(_translate("ques37", "2"))
        self.label_6.setText(_translate("ques37", "Határozd meg a {-2;-1;-1;0;0;1;1;1;2;3} számok móduszát!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques37.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques38(self.name,self.count,self.total)
