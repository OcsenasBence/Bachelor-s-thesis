...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya19.ui'
#
...
class Ui_ques19(QtWidgets.QWidget):
    ...
    def setupUi(self, ques19):
        ques19.setObjectName("ques19")
        ques19.resize(1024, 720)
        ques19.setMinimumSize(QtCore.QSize(1024, 720))
        ques19.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques19)
        ...
        ques19.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques19)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques19.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques19)
        self.statusbar.setObjectName("statusbar")
        ques19.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques19)
        QtCore.QMetaObject.connectSlotsByName(ques19)

    def retranslateUi(self, ques19):
        _translate = QtCore.QCoreApplication.translate
        ques19.setWindowTitle(_translate("ques19", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques19", "Esőerdő | Kilencedik feladat"))
        self.label_2.setText(_translate("ques19", "Becenév:"))
        self.label_3.setText(_translate("ques19", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques19", "9. feladat: Végezd el az alábbi műveletet!"))
        self.R1.setText(_translate("ques19", "3,6"))
        self.R2.setText(_translate("ques19", "3,7"))
        self.R3.setText(_translate("ques19", "3,8"))
        self.B1.setText(_translate("ques19", "Következő"))
        self.R4.setText(_translate("ques19", "3,9"))
        self.label_6.setText(_translate("ques19",
                                        "<html><head/><body><p><span style=\" font-size:14pt;\">54 : 15 = </span></p></body></html>"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques19.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques20(self.name, self.count, self.total)
