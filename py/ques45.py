...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya45.ui'
#
...
import sys
from ques46 import *
class Ui_ques45(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques45):
        ques45.setObjectName("ques45")
        ques45.resize(1024, 720)
        ques45.setMinimumSize(QtCore.QSize(1024, 720))
        ques45.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques45)
        ...
        ques45.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques45)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques45.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques45)
        self.statusbar.setObjectName("statusbar")
        ques45.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques45)
        QtCore.QMetaObject.connectSlotsByName(ques45)

    def retranslateUi(self, ques45):
        _translate = QtCore.QCoreApplication.translate
        ques45.setWindowTitle(_translate("ques45", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques45", "Szavanna | Ötödik feladat"))
        self.label_2.setText(_translate("ques45", "Becenév:"))
        self.label_3.setText(_translate("ques45", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques45", "5. feladat:"))
        self.R1.setText(_translate("ques45", "2"))
        self.R2.setText(_translate("ques45", "3"))
        self.R3.setText(_translate("ques45", "6"))
        self.B1.setText(_translate("ques45", "Következő"))
        self.R4.setText(_translate("ques45", "17"))
        self.label_6.setText(_translate("ques45", "Határozd meg a {9;9;17;2;2;3} számok mediánját!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques45.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques46(self.name,self.count,self.total)
