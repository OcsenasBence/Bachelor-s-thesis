...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya36.ui'
#
...
import sys
from ques37 import *
class Ui_ques36(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques36):
        ques36.setObjectName("ques36")
        ques36.resize(1024, 720)
        ques36.setMinimumSize(QtCore.QSize(1024, 720))
        ques36.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques36)
        ...
        self.label_6.setGeometry(QtCore.QRect(140, 270, 731, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques36.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques36)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques36.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques36)
        self.statusbar.setObjectName("statusbar")
        ques36.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques36)
        QtCore.QMetaObject.connectSlotsByName(ques36)

    def retranslateUi(self, ques36):
        _translate = QtCore.QCoreApplication.translate
        ques36.setWindowTitle(_translate("ques36", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques36", "Hegyvidék | Hatodik feladat"))
        self.label_2.setText(_translate("ques36", "Becenév:"))
        self.label_3.setText(_translate("ques36", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques36", "6. feladat:"))
        self.R1.setText(_translate("ques36", "701"))
        self.R2.setText(_translate("ques36", "702"))
        self.R3.setText(_translate("ques36", "705"))
        self.B1.setText(_translate("ques36", "Következő"))
        self.R4.setText(_translate("ques36", "707"))
        self.label_6.setText(_translate("ques36", "Határozd meg a {701;702;703;704;705;706;701;707;708;709;710} számok móduszát!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques36.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques37(self.name,self.count,self.total)
