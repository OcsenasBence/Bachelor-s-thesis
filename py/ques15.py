...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya15.ui'
#
...
class Ui_ques15(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques15):
        ques15.setObjectName("ques15")
        ques15.resize(1024, 720)
        ques15.setMinimumSize(QtCore.QSize(1024, 720))
        ques15.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques15)
        ...
        ques15.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques15)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques15.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques15)
        self.statusbar.setObjectName("statusbar")
        ques15.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques15)
        QtCore.QMetaObject.connectSlotsByName(ques15)

    def retranslateUi(self, ques15):
        _translate = QtCore.QCoreApplication.translate
        ques15.setWindowTitle(_translate("ques15", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques15", "Esőerdő | Ötödik feladat"))
        self.label_2.setText(_translate("ques15", "Becenév:"))
        self.label_3.setText(_translate("ques15", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques15", "5. feladat: Végezd el az alábbi műveletet!"))
        self.R1.setText(_translate("ques15", "19,14"))
        self.R2.setText(_translate("ques15", "19,17"))
        self.R3.setText(_translate("ques15", "19,20"))
        self.B1.setText(_translate("ques15", "Következő"))
        self.R4.setText(_translate("ques15", "19,22"))
        self.label_6.setText(_translate("ques15", "<html><head/><body><p><span style=\" font-size:14pt;\">7,82 + 11,32 =</span></p></body></html>"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques15.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques16(self.name,self.count,self.total)
