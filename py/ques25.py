...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya25.ui'
#
...
import sys
from ques26 import *
class Ui_ques25(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques25):
        ques25.setObjectName("ques25")
        ques25.resize(1024, 720)
        ques25.setMinimumSize(QtCore.QSize(1024, 720))
        ques25.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques25)
        ...
        self.label_6.setGeometry(QtCore.QRect(220, 280, 561, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques25.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques25)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques25.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques25)
        self.statusbar.setObjectName("statusbar")
        ques25.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques25)
        QtCore.QMetaObject.connectSlotsByName(ques25)

    def retranslateUi(self, ques25):
        _translate = QtCore.QCoreApplication.translate
        ques25.setWindowTitle(_translate("ques25", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques25", "Sivatag | Ötödik feladat"))
        self.label_2.setText(_translate("ques25", "Becenév:"))
        self.label_3.setText(_translate("ques25", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques25", "5. feladat:"))
        self.R1.setText(_translate("ques25", "19000"))
        self.R2.setText(_translate("ques25", "15000"))
        self.R3.setText(_translate("ques25", "17000"))
        self.B1.setText(_translate("ques25", "Következő"))
        self.R4.setText(_translate("ques25", "6000"))
        self.label_6.setText(_translate("ques25", "Elköltöttem a pénzem 30%-át, 5100 forintot. Mennyi pénzem volt?"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques25.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques26(self.name,self.count,self.total)
