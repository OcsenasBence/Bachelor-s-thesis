...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya35.ui'
#
...
import sys
from ques36 import *
class Ui_ques35(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques35):
        ques35.setObjectName("ques35")
        ques35.resize(1024, 720)
        ques35.setMinimumSize(QtCore.QSize(1024, 720))
        ques35.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques35)
        ...
        self.label_6.setGeometry(QtCore.QRect(260, 270, 501, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques35.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques35)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques35.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques35)
        self.statusbar.setObjectName("statusbar")
        ques35.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques35)
        QtCore.QMetaObject.connectSlotsByName(ques35)

    def retranslateUi(self, ques35):
        _translate = QtCore.QCoreApplication.translate
        ques35.setWindowTitle(_translate("ques35", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques35", "Hegyvidék | Ötödik feladat"))
        self.label_2.setText(_translate("ques35", "Becenév:"))
        self.label_3.setText(_translate("ques35", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques35", "5. feladat:"))
        self.R1.setText(_translate("ques35", "322"))
        self.R2.setText(_translate("ques35", "323"))
        self.R3.setText(_translate("ques35", "324"))
        self.B1.setText(_translate("ques35", "Következő"))
        self.R4.setText(_translate("ques35", "325"))
        self.label_6.setText(_translate("ques35", "Határozd meg a {322;322;323;324;325} számok móduszát!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques35.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques36(self.name,self.count,self.total)
