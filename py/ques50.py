...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya50.ui'
#
...
import sys
from resultwin5 import *
class Ui_ques50(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques50):
        ques50.setObjectName("ques50")
        ques50.resize(1024, 720)
        ques50.setMinimumSize(QtCore.QSize(1024, 720))
        ques50.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques50)
        ...
        self.label_6.setGeometry(QtCore.QRect(170, 250, 681, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques50.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques50)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques50.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques50)
        self.statusbar.setObjectName("statusbar")
        ques50.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques50)
        QtCore.QMetaObject.connectSlotsByName(ques50)

    def retranslateUi(self, ques50):
        _translate = QtCore.QCoreApplication.translate
        ques50.setWindowTitle(_translate("ques50", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques50", "Szavanna | Tizedik feladat"))
        self.label_2.setText(_translate("ques50", "Becenév:"))
        self.label_3.setText(_translate("ques50", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques50", "10. feladat:"))
        self.R1.setText(_translate("ques50", "0"))
        self.R2.setText(_translate("ques50", "91"))
        self.R3.setText(_translate("ques50", "15"))
        self.B1.setText(_translate("ques50", "Következő"))
        self.R4.setText(_translate("ques50", "2063"))
        self.label_6.setText(_translate("ques50", "Határozd meg a {0;91;-485;2063;-4785;946;578;52;-12;0;15} számok mediánját!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques50.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_resultwin5(self.name,self.count,self.total)
