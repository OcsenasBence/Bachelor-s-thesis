...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya33.ui'
#
...
import sys
from ques34 import *
class Ui_ques33(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques33):
        ques33.setObjectName("ques33")
        ques33.resize(1024, 720)
        ques33.setMinimumSize(QtCore.QSize(1024, 720))
        ques33.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques33)
        ...
        self.label_4.setGeometry(QtCore.QRect(390, 70, 291, 41))
        ...
        self.label_6.setGeometry(QtCore.QRect(170, 270, 741, 81))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_6.setFont(font)
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques33.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques33)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques33.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques33)
        self.statusbar.setObjectName("statusbar")
        ques33.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques33)
        QtCore.QMetaObject.connectSlotsByName(ques33)

    def retranslateUi(self, ques33):
        _translate = QtCore.QCoreApplication.translate
        ques33.setWindowTitle(_translate("ques33", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques33", "Hegyvidék | Harmadik feladat"))
        self.label_2.setText(_translate("ques33", "Becenév:"))
        self.label_3.setText(_translate("ques33", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques33", "3. feladat:"))
        self.R1.setText(_translate("ques33", "1001"))
        self.R2.setText(_translate("ques33", "1002"))
        self.R3.setText(_translate("ques33", "1004"))
        self.B1.setText(_translate("ques33", "Következő"))
        self.R4.setText(_translate("ques33", "1005"))
        self.label_6.setText(_translate("ques33", "Határozd meg a {1001;1001;1002;1002;1003;1004;1004;1004;1005} számok móduszát!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques33.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques34(self.name,self.count,self.total)
