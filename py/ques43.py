...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya43.ui'
#
...
import sys
from ques44 import *
class Ui_ques43(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques43):
        ques43.setObjectName("ques43")
        ques43.resize(1024, 720)
        ques43.setMinimumSize(QtCore.QSize(1024, 720))
        ques43.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques43)
        ...
        ques43.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques43)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques43.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques43)
        self.statusbar.setObjectName("statusbar")
        ques43.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques43)
        QtCore.QMetaObject.connectSlotsByName(ques43)

    def retranslateUi(self, ques43):
        _translate = QtCore.QCoreApplication.translate
        ques43.setWindowTitle(_translate("ques43", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques43", "Szavanna | Harmadik feladat"))
        self.label_2.setText(_translate("ques43", "Becenév:"))
        self.label_3.setText(_translate("ques43", "Hátralévő idő:"))
        self.label_5.setText(_translate("ques43", "3. feladat:"))
        self.R1.setText(_translate("ques43", "7,5"))
        self.R2.setText(_translate("ques43", "8"))
        self.R3.setText(_translate("ques43", "8,5"))
        self.B1.setText(_translate("ques43", "Következő"))
        self.R4.setText(_translate("ques43", "9"))
        self.label_6.setText(_translate("ques43", "Határozd meg a {7;9;16;2;8;9} számok mediánját!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques43.close)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques44(self.name,self.count,self.total)
