...
# Form implementation generated from reading ui file 'C:\Users\ocsen\Desktop\szakdoga pyqt lapok\pálya8.ui'
#
...
class Ui_ques8(QtWidgets.QWidget):
    def __init__(self, name, count, total):
        super().__init__()
        self.name = name
        self.count = count
        self.total = total
    def setupUi(self, ques8):
        ques8.setObjectName("ques8")
        ques8.resize(1024, 720)
        ques8.setMinimumSize(QtCore.QSize(1024, 720))
        ques8.setMaximumSize(QtCore.QSize(1024, 720))
        self.centralwidget = QtWidgets.QWidget(ques8)
        ...
        self.label_6.setPixmap(QtGui.QPixmap("képek/8. feladat képe.png"))
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        ques8.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ques8)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 21))
        self.menubar.setObjectName("menubar")
        ques8.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ques8)
        self.statusbar.setObjectName("statusbar")
        ques8.setStatusBar(self.statusbar)
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.ShowTime)
        self.timer.start(1000)
        self.retranslateUi(ques8)
        QtCore.QMetaObject.connectSlotsByName(ques8)

    def retranslateUi(self, ques8):
        _translate = QtCore.QCoreApplication.translate
        ques8.setWindowTitle(_translate("ques8", "Játékos matematikai gyakorlóprogram"))
        self.label_4.setText(_translate("ques8", "Füves puszta | Nyolcadik feladat"))
        self.label_2.setText(_translate("ques8", "Becenév:"))
        self.label_3.setText(_translate("ques8", "Hátralévő idő:"))
        self.R1.setText(_translate("ques8", "4/5"))
        self.R2.setText(_translate("ques8", "1/1"))
        self.R3.setText(_translate("ques8", "6/7"))
        self.R4.setText(_translate("ques8", "3/4"))
        self.B1.setText(_translate("ques8", "Következő"))
        self.label_5.setText(_translate("ques8", "8. feladat: Egyszerüsítsd a képen látható törtet!"))
        self.B1.clicked.connect(self.opques)
        self.B1.clicked.connect(ques8.hide)
    ...
    def opques(self):
        ...
        self.ui = Ui_ques9(self.name,self.count,self.total)
